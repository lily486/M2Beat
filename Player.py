...
class Player:
    def __init__(self, stage, ground,  width, height):
        ...
        self.pos = vec(250, 1200 - 86 - 72)  # 플레이어 시작 위치 (가로, 세로)
    ...
    walk_frame = [slime.get_image(0, 72, 72, 72),
    ...
    def animate(self):  # 이미지 바꾸는 함수 (애니메이션)
        ...
        if self.party:
            if now_party - self.last_update_party > 80:
    ...
    def move(self):  # 플레이어 움직이는 함수
        ...
        self.stage.blit(self.warrior1, (150, self.height - self.ground_height - self.warrior1.get_height()))
        self.stage.blit(self.warrior2, (100, self.height - self.ground_height - self.warrior2.get_height()))
        self.stage.blit(self.warrior3, (50, self.height - self.ground_height - self.warrior3.get_height()))
        self.stage.blit(self.warrior4, (0, self.height - self.ground_height - self.warrior4.get_height()))
